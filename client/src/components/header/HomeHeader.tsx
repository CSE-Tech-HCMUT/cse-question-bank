    ...
    return (
        <Header className="home-header">
            ...
            <div className="flex items-center">
                <div className="logo">
                    <img className="responsive-img" src="/src/assets/images/hcmut.png" alt="logoHcmut" />
                </div>
                <span 
                    className="font-semibold md:text-[20px] lg:text-xl leading-8 text-[10px] text-white"
                >
