...
import { ContainerOutlined, FileOutlined, HomeOutlined, CodeOutlined, UserOutlined } from '@ant-design/icons'
    ...
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Layout>
        ...
        <Content style={{ margin: '16px' }}>
          <Breadcrumb style={{ margin: '16px 0' }} items={[{ title: 'User' }, { title }]} />
          <div
            style={{
              padding: 24,
              minHeight: 470,
        ...
        <Footer style={{ textAlign: 'center' }}>Question Bank ©{new Date().getFullYear()} Created by TCT Team</Footer>
      </Layout>
    </Layout>
  )
})
