...
\usepackage{./internal/module/latex_compiler/latex_source/dethi} %Gói lệnh cho đề thi Việt Nam
...
\begin{vnmultiplechoice}
    \begin{question}
        ...
        \begin{enumerate}
            \item Trả về một tham chiếu đến một biến cục bộ từ một hàm.
            \item Lưu trữ địa chỉ của một đối tượng được cấp phát động và sau đó xóa nó.
            \item Sử dụng con trỏ thông qua một tham số con trỏ được truyền vào một hàm và không giữ tham chiếu sau khi hàm kết thúc.
            \item Sử dụng một con trỏ sau khi giải phóng bộ nhớ mà nó trỏ đến.
        \end{enumerate}
    
        Số tình huống trong C/C++ dẫn đến tham chiếu (dangling reference):
